...
} from '@/services/api-tomato-backend  /userController';
...
import tomatoImg from '../../../../public/alottomato.jpeg';
  ...
  const handleSubmit = async (values: API.UserRegisterRequest) => {
    ...
    if (checkPassword) {
      ...
      if (res.data) {
        ...
        console.log(res.data.loginUserData);
        // 保存登录状态
        setInitialState({
          ...initialState,
