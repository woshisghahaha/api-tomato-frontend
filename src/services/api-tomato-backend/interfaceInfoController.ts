...
/** ListOwnInterfaceInfoVOByPage POST /api/interfaceInfo/own/list/page/vo */
export async function ListOwnInterfaceInfoVOByPageUsingPOST(
  body: API.InterfaceInfoQueryRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageInterfaceInfoVO>('/api/interfaceInfo/own/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
